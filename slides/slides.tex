  ...
  \begin{frame}  
    ...
    \tikz[remember picture,overlay] {
      \node[xshift=6.8125cm,yshift=0.3cm]
           {\includegraphics[width=1.5cm,clip]{decisym_qr_code_dark_2025-08-08.png}};
    }    
  \end{frame}
}
...
% This frame shows the general concept of joining disparate datasets to
% form a knowledge graph, generate analytics, and extract actionable insights
...
\begin{frame}{Contacts}
  ...
  {\includegraphics[width=2.5cm,clip]{decisym_qr_code_dark_2025-08-08.png}};
  }
\end{frame}
